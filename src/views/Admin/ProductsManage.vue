                 ...
                 <div class="form-row">
                  <div class="form-group col-md-6">
                      ...
                      <input type="text" id="category" class="form-control" placeholder="請輸入分類"
                       v-model="tempProduct.options.mainCategory">
                    </div>
                    <div class="form-group col-md-6">
...
export default {
  ...
  methods: {
    ...
    updateProduct() {
      ...
      var size = vm.tempProduct.options.size;
      if (typeof (size) === 'string') {
        vm.tempProduct.options.size = size.split(',');
      }
      // vm.tempProduct.options.size = vm.tempProduct.options.size.split(',');
    ...
    uploadFile() {
      ...
      vm.$http.post(api, formData, {
        ...
        if (response.data.success) {
          ...
          vm.tempProduct.imageUrl.push(response.data.imageUrl);
        } else {
