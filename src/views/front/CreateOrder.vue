    ...
    <div>
        ...
        <div class="table-responsive" v-if="step === 1">
            <table class="table mb-4">
                ...
                <tbody>
                    <tr v-for="cart in carts.carts" :key="cart.id">
                        <td class="d-md-table-cell text-center d-none">
                            <div class="thumbnail"
                            :style="{backgroundImage: `url(${cart.product.imageUrl})`}">
                            </div>
                        </td>
                        <td class="">
                            {{ cart.product.title }}({{ cart.size}})
                ...
                <tfoot class="border-top table-borderless bg-light">
                    <tr>
            ...
            <!-- <div class="input-group mb-4">
                ...
                <div class="input-group-append" @click.prevent="">
        ...
        <div v-if="step === 2" class="mb-4">
            <div id="accordion">
                <div class="card mb-4">
                    <div class='bg-light p-2' id="headingOne">
                        <h5 class="mb-0">
                    ...
                    <div id="collapseOne" class="collapse border-top"
                    aria-labelledby="headingOne" data-parent="#accordion">
                        <div class="card-body">
                            <table class="table">
                                ...
                                <tbody>
                                    <tr v-for="cart in carts.carts" :key="cart.id">
                                        <td> {{ cart.product.title}} ({{ cart.size}})</td>
            ...
            <div>
                ...
                <form @submit.prevent="createOrder">
                    ...
                    <div class="form-group">
                        ...
                        placeholder="請輸入 收件人姓名" v-model="form.user.name">
                ...
                <table class="table mb-3">
                    ...
                    <tbody>
                        <tr v-for="orderItem in order.products" :key="orderItem.id">
                            <td> {{ orderItem.product.title}} ({{ orderItem.size }})</td>
