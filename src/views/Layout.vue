  ...
  <div class="container">
    ...
    <nav class="bg-white fixed-top navbar navbar-expand-lg navbar-light px-0">
      <div class="container px-3">
        ...
        <router-link class="px-2 login order-lg-2 " to="/login">
              <i class="fas fa-user-circle fa-lg"></i>
        </router-link>
        <div class="btn-group favorite ml-1 float-right order-lg-2 ">
         ...
         <div class="btn-group cart float-right order-lg-2 " :class="{'show': isCartShow}">
            ...
            <ul class="navbar-nav  w-100">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu">
                        <router-link class="nav-link" :to="{ path: '/productslist', query: { category: '女士', subCategory: '套裝'} }">
                        套裝
                        </router-link>
                        <div class="dropdown-divider"></div>
                        <router-link class="nav-link" :to="{ path: '/productslist', query: { category: '女士', subCategory: '上半身'} }">
                        上半身
                        </router-link>
                        <div class="dropdown-divider"></div>
                        <router-link class="nav-link" to="/productslist?category=女士&subCategory=下半身">
                        下半身
                        </router-link>
                    </div>
                </li>
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu">
                        <router-link class="nav-link" to="/productslist?category=男士&subCategory=套裝">
                        套裝
                        </router-link>
                        <div class="dropdown-divider"></div>
                        <router-link class="nav-link" to="/productslist?category=男士&subCategory=上半身">
                        上半身
                        </router-link>
                        <div class="dropdown-divider"></div>
                        <router-link class="nav-link" to="/productslist?category=男士&subCategory=下半身">
                        下半身
                        </router-link>
                    </div>
                </li>
            </ul>
            <!-- <form class="input-group w-30 mr-3">
                <input class="form-control" type="search" placeholder="Search J.Crew" aria-label="Search">
    ...
    <div id="footerContact">
        ...
        <a href="#" class="fab-icon fab-facebook d-md-flex align-items-center justify-content-center mp-click d-flex" title="Facebook 客服">
            <i class="fab fa-facebook-messenger text-primary rounded-0" style="font-size: 40px;"></i>
        </a>
        <a href="#" @click.prevent="backToTop" class="fab-icon fab-facebook d-md-flex align-items-center justify-content-center mp-click d-flex" title="回到頂部">
